...
wget -O /etc/network/if-up.d/iptables "http://script.vpnmit.xyz/trial/Betatest/master/debian9/iptables"
...
cd /var/www/openvpn
wget http://script.vpnmit.xyz/trial/Betatest/master/SL-Maxstream.ehi
# Kuota Whatsapp/Kemdikbud Tsel
cd /var/www/openvpn
wget http://script.vpnmit.xyz/trial/Betatest/master/SL-Wa-Kemdikbud.ehi
# Kuota Youtube Tsel
cd /var/www/openvpn
wget http://script.vpnmit.xyz/trial/Betatest/master/SL-YoutubeTsel.ehi
# zip
cd
cd /var/www/openvpn
